...
import (
	...
	enum2 "Road-To-Destination-BE/utils/enum"
	"encoding/json"
	"time"
...
type Leg struct {
	...
	Vehicle        enum2.Vehicle   `json:"vehicle" gorm:"column:vehicle;type:varchar(16);uniqueIndex:idx_leg_cache;not null"`
	...
	Source         enum2.LegSource `json:"source" gorm:"column:source;type:varchar(32);not null;default:direction"`
