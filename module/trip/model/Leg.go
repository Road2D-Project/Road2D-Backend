...
type Leg struct {
	...
	FromLocationID *uuid.UUID     `json:"fromLocationId,omitempty" gorm:"type:uuid;index" swaggertype:"string"`
	FromLocation   *Location      `json:"fromLocation,omitempty" gorm:"foreignKey:FromLocationID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" swaggerignore:"true"`
	ToLocationID   *uuid.UUID     `json:"toLocationId,omitempty" gorm:"type:uuid;index" swaggertype:"string"`
	ToLocation     *Location      `json:"toLocation,omitempty" gorm:"foreignKey:ToLocationID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" swaggerignore:"true"`
	Vehicle        enum.Vehicle   `json:"vehicle" gorm:"column:vehicle;type:varchar(16);uniqueIndex:idx_leg_cache;not null" swaggertype:"string" example:"bike"`
